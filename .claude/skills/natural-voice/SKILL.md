...
# Natural Voice — Claude Code Entrypoint (v0.7 compatibility wrapper)

Canonical adapter: `adapters/claude/SKILL.md`. Shared methodology: `core/`.
This file keeps the Claude Code discovery path
(`.claude/skills/natural-voice/SKILL.md`) working unchanged.

## How to execute

1. Read `adapters/claude/SKILL.md` and follow it (installation, capability
